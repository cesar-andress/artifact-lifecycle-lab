...
rq5-v1-blind-lb-annotation-kit: rq5-v1-blind-lb-packets
	$(PY) -m artifact_lab.experiments.truth_decay.rq5_experiment.blind_lb_annotation_kit \
	  --packets-root exports/rq5_lb_blind_annotation \
	  --seed 42
