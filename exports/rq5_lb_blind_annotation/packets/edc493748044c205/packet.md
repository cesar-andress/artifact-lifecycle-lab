# Annotation packet `edc493748044c205`
...
1. ``[[REF]]` — data-driven CSS Grid layout component for React. See `README.md` for API and usage.`

2. `yarn workspace [[REF]] prepack`

3. `yarn workspace [[REF]] tsc --build --dry`

4. `yarn workspace [[REF]] test`

5. `yarn workspace [[REF]] storybook:start`

6. `Published to npm as `[[REF]]`. Steps:`

7. `- Verify on [npmjs.com](https://www.npmjs.com/package/[[REF]])`

8. `- `git tag "[[REF]]@<version>"``
